...
| **images** | kept cards wanting one | `card_images` | Only for cards whose answer could be drawn — an architecture, a lifecycle, the shape of a plot. DuckDuckGo first, Wikimedia as a fallback, everything re-encoded to JPEG because Anki silently drops some PNGs. |
